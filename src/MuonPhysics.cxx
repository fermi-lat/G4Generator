...
// $Header: /nfs/slac/g/glast/ground/cvs/G4Generator/src/MuonPhysics.cxx,v 1.9 2004/12/08 01:33:54 usher Exp $
//
...
void MuonPhysics::ConstructProcess()
{
  ...
  pManager->AddProcess(fMuPlusPairProduction,     ordInActive,           2, 2);
  pManager->AddProcess(fMuPlusNuclear,            ordInActive, ordInActive, 3);
  pManager->AddProcess(fMuPlusIonisation,         ordInActive,           3, 4);
  pManager->AddProcess(fMuPlusBremsstrahlung,     ordInActive,           4, 5);
  ...
  pManager->AddProcess(fMuMinusPairProduction,     ordInActive,           2, 2);
  pManager->AddProcess(fMuMinusNuclear,            ordInActive, ordInActive, 3);
  pManager->AddProcess(fMuMinusIonisation,         ordInActive,           3, 4);
  pManager->AddProcess(fMuMinusBremsstrahlung,     ordInActive,           4, 5);
...
/*
  ...
  pManager->AddProcess(fMuPlusBremsstrahlung,     ordInActive, ordInActive, 3);
  pManager->AddProcess(fMuPlusPairProduction,     ordInActive, ordInActive, 4);
  ...
  pManager->AddProcess(fMuMinusBremsstrahlung,     ordInActive, ordInActive, 3);
  pManager->AddProcess(fMuMinusPairProduction,     ordInActive, ordInActive, 4);
